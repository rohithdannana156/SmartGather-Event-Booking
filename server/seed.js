...
const users = [
    { name: 'Admin User', email: 'admin@SmartGather.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@SmartGather.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@SmartGather.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@SmartGather.com');
        console.log('User Email:  user@SmartGather.com');
